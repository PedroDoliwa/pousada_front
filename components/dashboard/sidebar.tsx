...
import { DASHBOARD_NAV, DashboardMark } from "@/components/dashboard/nav-config";
import type { StoredAuth } from "@/lib/auth/session";
      ...
      <div className="border-t border-slate-800 p-3">
        <div className="flex items-center gap-3 rounded-lg bg-slate-800/80 px-3 py-2.5">
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="truncate text-xs text-slate-400">{auth.user.perfil}</p>
          </div>
